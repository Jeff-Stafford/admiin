  ...
  constructor(scope: Construct, id: string, props: AuthStackProps) {
    ...
    const identityPool = new IdentityPool(this, identitypoolConstructName, {
      ...
      authenticationProviders: {
        userPools: [
          //TODO: review this, remove one? or will be used for mobile app?
    ...
    new CfnOutput(this, 'IdentityPoolUnauthenticatedRoleArn', {
      ...
      exportName: `${appPrefix}-${env}-UnauthenticatedRoleArn`,
    });
    ...
    // userpool id
    new StringParameter(this, 'UserPoolIdString', {
      parameterName: 'userPoolId',
      stringValue: userPool.userPoolId,
    });

    // userpool client id
    new StringParameter(this, 'UserPoolClientIdString', {
